...
- Keep taking the next **Ready** story until (a) none remain, (b) usage is limited, or (c) **08:00 America/Los_Angeles**.
- Hard stop at **08:00** America/Los_Angeles.
...
- Stop retrying only at 08:00, when usage is limited, or when no Ready stories remain
...
Tonight: prune chain #36 → #37 → #41. Official LinkedIn CSVs may arrive later; implement import against fixtures until then.
